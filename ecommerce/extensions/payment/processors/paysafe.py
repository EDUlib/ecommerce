...
from ecommerce.extensions.payment.exceptions import (InvalidSignatureError, InvalidPaysafeDecision,
...
class Paysafe(BasePaymentProcessor):
    """
    Faudrait mettre les bons liens vers la documentation de Paysafe
    """
    ...
    def __init__(self, site):
        ...
        super(Paysafe, self).__init__(site)
    ...
    def cancel_page_url(self):
        return get_lms_url(self.configuration['cancel_checkout_path'])

    def get_transaction_parameters(self, basket, request=None):
        """
        Generate a dictionary of signed parameters Paysafe requires to complete a transaction.
        ...
        Returns:
            dict: Paysafe-specific parameters required to complete a transaction, including a signature.
        """
        ...
        parameters = {
            ...
            'override_custom_receipt_page': 'http://ec2-52-60-96-25.ca-central-1.compute.amazonaws.com//commerce/checkout/receipt/?orderNum={}'.format(basket.order_number),
        ...
        redirect = [{
          "rel":'on_success',
          'returnKeys': [ "id" ],
          'uri':  urljoin(self.ecommerce_path, "{}?orderNum={}".format(reverse('paysafe_notify'), basket.order_number)),
          'delimiter': '&',
        }]
        ...
        callback_def = [{
          ...
          'uri':  urljoin(self.ecommerce_path, "{}?orderNum={}&id={}".format(reverse('paysafe_notify'), basket.order_number, "this_is_a_string_too")),
          'retries': 1,
        }]
        ...
        # Added by EDUlib
        #####logger.info("id de paysafe = %s", response_object.id)
    ...
    def handle_processor_response(self, response, basket=None):
        """
        Handle a response (i.e., "merchant notification") from Paysafe.
        ...
        Raises:
            ...
            InvalidPaysafeDecision: Indicates an unknown decision value.
    ...
    def issue_credit(self, source, reference_number, amount, currency):
        ...
        # Added by EDUlib
        # recuperation du ref number chez Paysafe
