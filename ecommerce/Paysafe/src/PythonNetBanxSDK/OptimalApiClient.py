...
# EDUlib Python 3
from ecommerce.Paysafe.src.bin.Environment import Environment

# EDUlib Python 2
#####from PythonNetBanxSDK.CustomerVault.CustomerVaultService import CustomerVaultService
#####from PythonNetBanxSDK.CardPayments.CardPaymentsService import CardPaymentsService
#####from PythonNetBanxSDK.HostedPayment.HostedPaymentService import HostedPaymentService
#####from PythonNetBanxSDK.common.DomainObject import DomainObject
#####from PythonNetBanxSDK.common.Error import Error

# EDUlib Python 3
from ecommerce.Paysafe.src.PythonNetBanxSDK.CustomerVault.CustomerVaultService import CustomerVaultService
from ecommerce.Paysafe.src.PythonNetBanxSDK.CardPayments.CardPaymentsService import CardPaymentsService
from ecommerce.Paysafe.src.PythonNetBanxSDK.HostedPayment.HostedPaymentService import HostedPaymentService
